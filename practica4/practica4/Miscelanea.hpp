...
public:
	...
	inline double Fitness(double valor1, double valor2){
        ...
        void GuardarGrafo(std::vector<Solucion >  grafo,InstanceTSP instancia,const int &it){
   ...
   void creaGrafo(std::vector<Solucion >  grafo,InstanceTSP instancia,const int &it){
